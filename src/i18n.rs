...
pub struct Strings {
    ...
    pub sf_action_setup: &'static str,
    pub sf_action_enable: &'static str,
    pub sf_action_disable: &'static str,
...
pub const EN: Strings = Strings {
    ...
    sf_action_migrate: "Migrate",
    sf_action_delete: "Delete",
    sf_action_setup: "One-key setup",
    sf_action_enable: "Enable",
    sf_action_disable: "Disable",
...
pub const ZH: Strings = Strings {
    ...
    sf_action_create: "创建",
    sf_action_migrate: "迁移",
    sf_action_delete: "删除",
    sf_action_setup: "一键配置",
    sf_action_enable: "启用",
    sf_action_disable: "停用",
