...
pub const EN: Strings = Strings {
    ...
    hint_sakurafrp: "↑/↓ sel  Enter copy  t token  o open  c new  m mig  d del  e on  x off  r ref  q quit",
...
pub const ZH: Strings = Strings {
    ...
    hint_sakurafrp: "↑/↓ 选  Enter 复制  t token  o 打开  c 创建  m 迁移  d 删除  e 启用  x 停用  r 刷新  q 退出",
